...
export const Route = createFileRoute("/safety")({
  head: () => ({ meta: [
    ...
    { name: "description", content: "Monitor warehouse safety risks, violations, and incident resolution." },
    { property: "og:title", content: "Safety Monitoring | WarehouseVision AI" },
    { property: "og:description", content: "Monitor warehouse safety risks, violations, and incident resolution." },
